"use client";
import { books } from "../../../constants/booksData";
...
export default function BookPage() {
  ...
  const selectedBook = books.filter((book, i) => {
    return bookId === String(book.bookId);
  });
  ...
  useEffect(() => {
    const savedDom = localStorage.getItem(`dom${selectedBook[0].bookId}`);
    if (savedDom) {
